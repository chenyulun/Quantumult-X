...
//      */
//     let proxies = (config?.proxies || []).filter(Boolean)
//       .filter((a) => {
//         const multiplier =
...
//   config.proxies = (config?.proxies || []).filter(Boolean)
//   config.proxies.push({
//     name: '直连',
//     type: 'direct',
//     udp: true,
...
// }
// /***
//  * Clash Verge Rev 全局扩展脚本（懒人配置）/ Mihomo Party 扩展脚本
//  * URL: https://github.com/xiaolin-007/clash-verge-script/blob/main/%E6%89%A9%E5%B1%95%E8%84%9A%E6%9C%AC.js
//  */
...
const rules = [
  ...
  "DOMAIN-SUFFIX,365-288.com,全局直连", // 265-288走直连
  "DOMAIN-SUFFIX,365lpodds.com,全局直连", // 265-288走直连
  // Loyalsoldier 规则集
