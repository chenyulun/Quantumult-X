  ...
  config["proxy-groups"] = [
    {
      ...
      "name": "节点选择",
      "type": "select",
      "proxies": ["延迟选优", "HK香港", "US美国", "JP日本", "故障转移"],
      "include-all": true,
      "filter": "^(?!.*(官网|套餐|流量|异常|剩余|群组)).*$",
    ...
    },
    {
      ...
      "name": "谷歌服务",
      "type": "select",
      "proxies": ["节点选择", "延迟选优", "HK香港", "US美国", "JP日本", "故障转移","全局直连"],
      "include-all": true,
    ...
    },
    {
      ...
      "type": "select",
      "include-all": true,
      "proxies": ["节点选择", "延迟选优", "HK香港", "US美国", "JP日本", "故障转移"],
    ...
    },
    {
      ...
      "name": "微软服务",
      "type": "select",
      "proxies": ["全局直连", "节点选择", "HK香港", "US美国", "JP日本", "延迟选优"],
      "include-all": true,
